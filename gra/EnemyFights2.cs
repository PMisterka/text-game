...
namespace CeltyckaPrzygoda
{
    class EnemyFights2
    {
        public static void Fights2(Player player, Enemies enemy, Random rnd, int minAttack, int maxAttack)
        {
                ...
                switch (action)
                {
                    ...
                    case "3":
                        ...
                        if (dodge != 5)
                        {
                            ...
                            if (dodge2 < 5)
                            {                             
                                Console.WriteLine("\nTy i Erin unikneliście ataku. Regenerujesz 3 punkty życia.");
                                player.Heal(3);
                            }
                            else
                            {
                                Console.WriteLine("\nTy i Erin unikneliście ataku.");
                            }
        ...
        public static void BossFight2(Player player, Enemies boss, Random rnd, int minAttack, int maxAttack)
        {
            Console.ForegroundColor = ConsoleColor.DarkMagenta;
                ...
                switch (action)
                {
                    ...
                    case "3":
                        ...
                        if (dodge != 5)
                        {
                            ...
                            if (dodge2 < 5)
                            {
                                Console.WriteLine("\nTy i Erin unikneliście ataku. Regenerujesz 5 punktów życia.");
                                player.Heal(5);
                            }
                            else
                            {
